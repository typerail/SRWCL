...
from modules import seed_utils
...
if __name__ == '__main__':
    ...
    parser.add_argument('--lambda3', type=float, default=0.01, help='the weights of GAN loss')
    ...
    parser.add_argument('--image_val_dir', type=str, default='./Datasets/test/')
